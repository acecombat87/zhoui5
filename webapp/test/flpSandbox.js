		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#atclouddnatraining01zhoui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atclouddnatraining01zhoui5-display": {
								"semanticObject": "atclouddnatraining01zhoui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.clouddna.training01.zhoui5",
									"url": sap.ui.require.toUrl("at/clouddna/training01/zhoui5")
								}
							}
						}
					}
